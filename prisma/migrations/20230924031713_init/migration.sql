...
-- CreateTable
CREATE TABLE "admissionist" (
    "admissionist_id" SERIAL NOT NULL,

    CONSTRAINT "admissionist_pkey" PRIMARY KEY ("admissionist_id")
);
...
-- AddForeignKey
ALTER TABLE "cash_register_transaction" ADD CONSTRAINT "cash_register_transaction_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "payment"("payment_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cash_register" ADD CONSTRAINT "cash_register_admissionist_id_fkey" FOREIGN KEY ("admissionist_id") REFERENCES "admissionist"("admissionist_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "payment" ADD CONSTRAINT "payment_admissionist_id_fkey" FOREIGN KEY ("admissionist_id") REFERENCES "admissionist"("admissionist_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payment" ADD CONSTRAINT "payment_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("user_id") ON DELETE SET NULL ON UPDATE CASCADE;
