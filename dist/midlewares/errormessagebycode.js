...
exports.getErrorMessageByCode = void 0;
...
const errorCodes = [
    ...
    {
        code: "P2007",
        message: "Error de la base de datos: el valor no es válido para el tipo de datos.",
    },
    {
        code: "P2008",
...
exports.getErrorMessageByCode = getErrorMessageByCode;
