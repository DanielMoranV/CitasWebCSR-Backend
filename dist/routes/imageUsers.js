...
const handleImageNotFoundError = (req, res, next) => {
    const imagePath = path_1.default.join(__dirname, "../public/imgusers", req.params.nameimg);
...
router.get("/photoprofile/image/:nameimg/:timestamp", handleImageNotFoundError, (req, res) => {
    const imagePath = path_1.default.join(__dirname, "../public/imgusers", req.params.nameimg);
